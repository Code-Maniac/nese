...
# 339 "main.cpp"
 ...
 void set_carry(unsigned char val) { P = P | val; }
 void set_zero(unsigned char val) { P = P | (val << 1); }
 void set_interrupt(unsigned char val) { P = P | (val << 2); }
 void set_decimal(unsigned char val) { P = P | (val << 3); }
 void set_break(unsigned char val) { P = P | (val << 4); }
 void set_overflow(unsigned char val) { P = P | (val << 6); }
 void set_negative(unsigned char val) { P = P | (val << 7); }
...
# 672 "main.cpp"
 void next() {
  ...
  case 0xD6: { ; }
  case 0xCE: { ; }
  case 0xDE: { --addr; break;; }
  case 0xCA: { --X; break;; }
  case 0x88: { --Y; break;; }
  case 0xE6: { ; }
  case 0xF6: { ; }
  case 0xEE: { ; }
  case 0xFE: { ++addr; break;; }
  case 0xE8: { ++X; break;; }
  case 0xC8: { ++Y; break;; }
  case 0x0A: { ; }
  case 0x06: { ; }
  case 0x16: { ; }
  case 0x0E: { ; }
  case 0x1E: { addr *= 2; break;; }
  case 0x2A: { ; }
  case 0x26: { ; }
  case 0x36: { ; }
  case 0x2E: { ; }
  case 0x3E: { addr = 2 * addr + get_carry(); break;; }
  case 0x4A: { ; }
  case 0x46: { ; }
  case 0x56: { ; }
  case 0x4E: { ; }
  case 0x5E: { addr /= 2; break;; }
  case 0x6A: { ; }
  case 0x66: { ; }
  case 0x76: { ; }
  case 0x6E: { ; }
  case 0x7E: { addr = addr / 2 + get_carry() * 0x80; break;; }
  case 0xA9: { ; }
  case 0xA5: { ; }
  case 0xB5: { ; }
  case 0xA1: { ; }
  ...
  case 0x8D: { ; }
  case 0x9D: { ; }
  case 0x99: { addr = A; break;; }
  case 0xA2: { ; }
  case 0xA6: { ; }
  case 0xB6: { ; }
  case 0xAE: { ; }
  case 0xBE: { X = addr; break;; }
  case 0x86: { ; }
  case 0x96: { ; }
  case 0x8E: { addr = X; break;; }
  case 0xA0: { ; }
  case 0xA4: { ; }
  case 0xB4: { ; }
  case 0xAC: { ; }
  case 0xBC: { Y = addr; break;; }
  case 0x84: { ; }
  case 0x94: { ; }
  case 0x8C: { addr = Y; break;; }
  case 0xAA: { X = A; break;; }
  case 0x8A: { A = X; break;; }
  case 0xA8: { Y = A; break;; }
  case 0x98: { A = Y; break;; }
  ...
  case 0x24: { ; }
  case 0x2C: { ; }
  case 0x18: { set_carry(0x00); break;; }
  case 0x38: { set_carry(0x01); break;; }
  case 0xD8: { set_decimal(0x00); break;; }
  case 0xF8: { set_decimal(0x01); break;; }
  case 0x58: { set_interrupt(0x00); break;; }
  case 0x78: { set_interrupt(0x01); break;; }
  case 0xB8: { set_overflow(0x00); break;; }
  case 0xEA: { ; }
  default:
   break;
  }
